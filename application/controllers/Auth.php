...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'hamzahhamah066@gmail.com'; // isi dgn email
        $config['smtp_pass'] = 'wvsxruhunikdyhfd'; // password harus sesuai
        $config['smtp_port'] = '465';
        $config['malltype'] = 'html';
        $config['charset'] = 'utf-8';
        $config['newline'] = "\r\n";
        $this->email->initialize($config);
        $this->email->from('hamzahhamah066@gmail.com', 'hamzah');
